...
|---|---|---|
| `--cve` | `--cve CVE-2026-1340` | Filter by CVE ID (substring) |
...
| "最近有什么新漏洞" / "what's new" | `query --pushed --days 1` |
| "Fortinet 相关的" | `query --source Fortinet` |
| "查一下 CVE-2026-1340" | `query --cve CVE-2026-1340` |
| "CISA KEV 最近一周" | `query --source CISA_KEV --days 7` |
| "有没有 RCE" | `query --reason RCE --days 7` |
